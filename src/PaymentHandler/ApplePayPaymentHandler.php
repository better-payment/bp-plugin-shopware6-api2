...
//        $this->orderRepository = $orderRepository;
    ...
    {
        $this->storeBetterPaymentTransactionId($transaction->getOrderTransactionId(), $request->get('betterpayment_apple_pay_transaction_id'), $context);
        $this->storeBetterPaymentApplePayOrderId($transaction->getOrderTransactionId(), $request->get('betterpayment_apple_pay_order_id'), $context);
        $this->paymentStatusMapper->updateOrderTransactionStateFromPaymentHandler($transaction->getOrderTransactionId(), $request->get('betterpayment_apple_pay_transaction_status'), $context);
    ...
    private function storeBetterPaymentApplePayOrderId(string $orderTransactionId, string $betterPaymentApplePayOrderId, Context $context): void
    {
        $this->orderTransactionRepository->update([
            [
                'id' => $orderTransactionId,
